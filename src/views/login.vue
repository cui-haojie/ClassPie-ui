...
<template>
  ...
  <div class="login_container">
    ...
    <div class="login_form" id="login_form">
      ...
      <br>
      <!--      <span class="error-message" style="position: relative;top:-25px">验证错误</span><br>-->
      <div class="form">
        <div style="display: flex;align-items: center;height: 50px">
          <input id="checkBox01" type="checkbox" style="left: 45px;
          position: absolute;font-size: 30px;transform: scale(1.4);accent-color: rgb(218,220,224);font-weight: 1">
          <div class="checkbox">
            下次自动登陆
          </div>
          <div style="width: 270px;margin-bottom: 20px"></div>
      ...
      <div style="font-size: 18px;margin-top: 20px;right: 40px;position: absolute">还没有账号 ? <span
          @click="router.push('/register')"
          style="color: rgb(72, 138, 248);font-size: 18px">去注册</span></div>
    </div>
    <div class="gist"></div>
  </div>
