...
<template>
  <div class="live-class">
    ...
    <section v-if="activePanel === 'attendance'" class="live-panel">
      ...
      <div v-if="openSession && isTeacher" class="attendance-card">
        <h3>当前签到码</h3>
      ...
      <div v-else class="empty-hint">暂无进行中的签到</div>
      ...
      <div v-if="isTeacher && openSession && attendanceDetail" class="attendance-lists">
